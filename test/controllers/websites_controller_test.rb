...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { description: @website.description, name: @website.name, online: @website.online } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { description: @website.description, name: @website.name, online: @website.online } }
